...
The Baylor-aligned design system applied to the announcement landing page: color tokens, typography pairing, decorative elements, photo treatment, and the wordmark lockup. Defines how the brand colors express Baylor's identity on the page without infringing on protected marks.
